...
public class OwnerDAO implements DAO<Owner> {
    ...
    @Override
    public List<Owner> getAllByOneId(Integer id) throws DaoException {
        throw new DaoException();
    }

    @Override
    public Owner getByTwoId(Integer id1, Integer id2) throws DaoException {
        throw new DaoException();
    }
